...
class Nearby extends React.Component {
	...
	initMap = () => {
		...
		console.log('hola', this.props.places)

		//Initialize Map
		map = new window.google.maps.Map(document.getElementById('map'), {
			center: this.state.createMap === false ? undefined : this.state.location,
			zoom: this.state.zoom
			// styles: mapStyle,
		});

		// Current this.state.location Marker
		...
		if (navigator.geolocation) {
			navigator.geolocation.getCurrentPosition(
				function(position) {
					...
					self.setState({ location: pos, createMap: true });
