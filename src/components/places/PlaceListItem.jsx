...
class PlaceListItem extends Component {
    render() {
        ...
        return (
            ...
            <NavLink to={`/place/${this.props.place._id}`}>

                <div className="row appy--place-list-item">
                    <div className="col-3 appy--place-list-item-img-col">
                        <div className="appy--place-list-item-img" style={{ backgroundImage: `url("${this.props.place ? this.props.place.image : 'Loading'}")` }} >
                            ...
                            <div className={`appy--place-list-item-rating ${this.props.recommended && 'recommended'}`} style={{ borderRadius: '0px 0px 0px 4px' }}>
                                <span className="appy--place-list-item-rating-num">{this.props.place ? this.props.place.rating : 'Loading'}</span>
                                {this.props.place.rating >= 1 ? <img src="/img/star-white-on.svg" alt="1" /> :
                                    this.props.place.rating >= 0.5 ? <img src="/img/star-white-half.svg" alt="1" /> :
                                        <img src="/img/star-off.svg" alt="1" />
                                }
                                {this.props.place.rating >= 2 ? <img src="/img/star-white-on.svg" alt="1" /> :
                                    this.props.place.rating >= 1.5 ? <img src="/img/star-white-half.svg" alt="1" /> :
                                        <img src="/img/star-off.svg" alt="2" />
                                }
                                {this.props.place.rating >= 3 ? <img src="/img/star-white-on.svg" alt="1" /> :
                                    this.props.place.rating >= 2.5 ? <img src="/img/star-white-half.svg" alt="1" /> :
                                        <img src="/img/star-off.svg" alt="3" />
                                }
                                {this.props.place.rating >= 4 ? <img src="/img/star-white-on.svg" alt="1" /> :
                                    this.props.place.rating >= 3.5 ? <img src="/img/star-white-half.svg" alt="1" /> :
                                        <img src="/img/star-off.svg" alt="4" />
                                }
                                {this.props.place.rating >= 5 ? <img src="/img/star-white-on.svg" alt="1" /> :
                                    this.props.place.rating >= 4.5 ? <img src="/img/star-white-half.svg" alt="1" /> :
                            ...
                            <div>
                                <div className="row">
                                    <div className="appy--col-10 appy--place-list-item-info">
                                        <h3 className="appy--place-list-item-info-title">{this.props.place ? textLength(this.props.place.name, 12, 18, 20) : 'Loading'}</h3>
                                        <p className="appy--place-list-item-info-description">{this.props.place ? textLength(this.props.place.address, 43, 53, 63) : 'Loading'}</p>
                                ...
                                <div>
                                    <div className="row">
                                        <div className="appy--col-3 appy--place-list-item-position">
                                            {this.props.type === 'num' ?
                                                <p className="appy--place-list-item-time-num">{this.props ? this.props.num + 1 : 'Loading'}</p>
                                                :
                                                <p className="appy--place-list-item-position-num">
                                                    <AppyButton type="delete" />
                                                </p>
                                        ...
                                        <div className="appy--col-7 appy--place-list-item-time">
                                            <div className="appy--place-list-item-time-info">
                                                ...
                                                <h3 className="appy--place-list-item-time-title">7 Min.</h3>
                                            </div>
                                            ...
                                            <div className="row appy--place-list-item-schedule-price">
                                                <div className="col-12 appy--place-list-item-schedule-price-open-icon">
                                                    <FontAwesomeIcon icon={faMapMarkerAlt} />
                                                    <div className="appy--col-5 appy--place-list-item-schedule-price-schedule-info" style={{ color: '#707070' }}>300 m.</div>
                                                </div>
                                        ...
                                        <div className="col-2 appy--place-list-item-position">
                                            {this.props.type === 'num' ?
                                                <p className="appy--place-list-item-position-num" style={{ marginRight: '7px' }}>{this.props ? this.props.num + 2 : 'Loading'}</p>
                                                :
                                                <p className="appy--place-list-item-position-num">
                                                    <AppyButton type="delete" />
                                                </p>
