    ...
    return (
      ...
      <div className="row appy--place-list-item">
        <div className="col-3 appy--place-list-item-img-col">
          ...
          >
            {/* {this.state.photo.map(photo => <img src={photo}/>)} */}
              ...
              <div className="row">
                <div className="appy--col-10 appy--place-list-item-info">
                  <h3 className="appy--place-list-item-info-title">
                    {this.props.place ?
                      textLength(this.props.place.name, 12, 18, 20) : 'Loading'}
                  </h3>
                  <p className="appy--place-list-item-info-description">
                    {this.props.place ?
                      textLength(this.props.place.formatted_address, 43, 53, 63) : 'Loading'}
                  </p>
...
export default PlaceListItemNearBy;
